...
(function($) {
    ...
    function setSlowScroll() {
        $('#header-main-menu ul li a[href^="#"], a.button, .slow-scroll, .num-comments a, .design-button').on("click", function(e) {
            if ($(this).attr('href') === '#') {
                e.preventDefault();
            } else {
                if ($(window).width() < 1300) {
                    if (!$(e.target).is('.sub-arrow')) {
                        ...
                        $('body').removeClass('element-open-menu element-open-menu-done');
    ...
    function multiClickFunctionStop(e) {
        ...
        $('body').toggleClass("element-open-menu").delay(500).queue(function(next) {
            $(this).toggleClass("element-open-menu-done");
            next();
        });
        $('#toggle').on("click", multiClickFunctionStop);
    }
...
(() => {
    ...
    __webpack_require__.m = a, e = [], __webpack_require__.O = (r, _, t, i) => {
    ...
    }(), __webpack_require__.o = (e, r) => Object.prototype.hasOwnProperty.call(e, r), t = {}, i = "design:", __webpack_require__.l = (e, r, _, a) => {
        if (t[e]) t[e].push(r);
        else {
            var n, c;
            if (void 0 !== _)
        ...
        var webpackJsonpCallback = (r, _) => {
            ...
            r = self.webpackChunkdesign = self.webpackChunkdesign || [];
        r.forEach(webpackJsonpCallback.bind(null, 0)), r.push = webpackJsonpCallback.bind(null, r.push.bind(r))
    })()
})();
/*! design - v3.4.6 - 19-10-2021 */
(self.webpackChunkdesign = self.webpackChunkdesign || []).push([
    [354], {
        7914: e => {
        ...
        8135: (e, t) => {
            ...
            class _default extends designModules.ViewModule {
                getDefaultSettings() {
                    return {
                        selectors: {
                            elements: ".design-element",
                            nestedDocumentElements: ".design .design-element"
                        },
                        classes: {
                            editMode: "design-edit-mode"
                        }
                    }
                }
                getDefaultElements() {
                ...
                getDocumentSettings(e) {
                    ...
                    if (this.isEdit) {
                        t = {};
                        const e = design.settings.page.model;
                        jQuery.each(e.getActiveControls(), (n => {
                            t[n] = e.attributes[n]
                        }))
                    } else t = this.$element.data("design-settings") || {};
                    return this.getItems(t, e)
                }
                runElementsHandlers() {
                    this.elements.$elements.each(((e, t) => designFrontend.elementsHandler.runReadyTrigger(t)))
                }
                onInit() {
                    this.$element = this.getSettings("$element"), super.onInit(), this.isEdit = this.$element.hasClass(this.getSettings("classes.editMode")), this.isEdit ? design.on("document:loaded", (() => {
                        design.settings.page.model.on("change", this.onSettingsChange.bind(this))
        ...
        3090: e => {
            "use strict";
            e.exports = designModules.ViewModule.extend({
                $element: null,
                ...
                __construct: function(e) {
                    this.isActive(e) && (this.$element = e.$element, this.isEdit = this.$element.hasClass("design-element-edit-mode"), this.isEdit && this.addEditorListeners())
                },
                isActive: function() {
                    return !0
                },
                findElement: function(e) {
                    ...
                    return t.find(e).filter((function() {
                        return jQuery(this).closest(".design-element").is(t)
                    }))
                },
                ...
                addEditorListeners: function() {
                    ...
                    this.getEditorListeners().forEach((function(t) {
                        designFrontend.addListenerOnce(e, t.event, t.callback, t.to)
                    }))
                },
                removeEditorListeners: function() {
                    var e = this.getUniqueHandlerID();
                    this.getEditorListeners().forEach((function(t) {
                        designFrontend.removeListeners(e, t.event, null, t.to)
                    }))
                },
                ...
                getElementSettings: function(e) {
                    ...
                    if (this.isEdit && n) {
                        const e = designFrontend.config.elements.data[n],
                            s = e.attributes;
                        let i = s.widgetType || s.elType;
                        s.isInner && (i = "inner-" + i);
                        let r = designFrontend.config.elements.keys[i];
                        r || (r = designFrontend.config.elements.keys[i] = [], jQuery.each(e.controls, ((e, t) => {
                ...
                getEditSettings: function(e) {
                    var t = {};
                    return this.isEdit && (t = designFrontend.config.elements.editSettings[this.getModelCID()].attributes), this.getItems(t, e)
                },
                getCurrentDeviceSetting: function(e) {
                    return designFrontend.getCurrentDeviceSetting(this.getElementSettings(), e)
                },
                onInit: function() {
                    this.isActive(this.getSettings()) && designModules.ViewModule.prototype.onInit.apply(this, arguments)
                },
                onDestroy: function() {
        ...
        5658: e => {
            ...
            e.exports = designModules.ViewModule.extend({
                getDefaultSettings: function() {
                    return {
                        element: null,
                        direction: designFrontend.config.is_rtl ? "right" : "left",
                        selectors: {
                            container: window
                        }
                    }
                ...
                stretch: function() {
                    ...
                    r || (designFrontend.config.is_rtl && (o = s - (n.outerWidth() + o)), o = -o);
                    var c = {};
        ...
        7597: (e, t) => {
            ...
            class InstanceType {
                ...
                static getInstanceType() {
                    designModules.ForceMethodImplementation()
                }
            }
...
function() {
    ...
    window.jQuery && (window.jQuery.fn.designWaypoint = createExtension(window.jQuery)), window.Zepto && (window.Zepto.fn.designWaypoint = createExtension(window.Zepto))
}();
...
(self.webpackChunkdesign = self.webpackChunkdesign || []).push([
    [819], {
            ...
            class _default extends designModules.ViewModule {
                ...
                initDocumentClasses() {
                    this.documentClasses = {
                        base: s.default
                    }, designFrontend.hooks.doAction("design/frontend/documents-manager/init-classes", this)
                }
            ...
            e.exports = function(e) {
                ...
                const addElementsHandlers = () => {
                    ...
                    addHandlerWithHook = (e, t, n = "default") => {
                        n = n ? "." + n : "", designFrontend.hooks.addAction(`frontend/element_ready/${e}${n}`, (e => {
                ...
                this.addHandler = function(e, n) {
                    ...
                    return designCommon.helpers.softDeprecated("getHandlers", "3.1.0", "designFrontend.elementsHandler.getHandler"), e ? this.getHandler(e) : this.elementsHandlers
                }, this.runReadyTrigger = function(t) {
                    if (designFrontend.config.is_static) return;
                    const n = jQuery(t),
                        i = n.attr("data-element_type");
                    if (i && (designFrontend.hooks.doAction("frontend/element_ready/global", n, e), designFrontend.hooks.doAction(`frontend/element_ready/${i}`, n, e), "widget" === i)) {
                        const t = n.attr("data-widget_type");
                        designFrontend.hooks.doAction(`frontend/element_ready/${t}`, n, e)
                    }
                }, this.init = () => {
                    designFrontend.hooks.addAction("frontend/element_ready/global", s.default), addElementsHandlers()
                }
            }
        },
        5654: (e, t, n) => {
            ...
            const v = n(9469),
                b = n(9804),
                y = n(3346);
            class Frontend extends designModules.ViewModule {
                constructor(...e) {
                    super(...e), this.config = designFrontendConfig, this.config.legacyMode = {
                        get elementWrappers() {
                            return designFrontend.isEditMode() && designCommon.helpers.hardDeprecated("designFrontend.config.legacyMode.elementWrappers", "3.1.0", "designFrontend.config.experimentalFeatures.e_dom_optimization"), !designFrontend.config.experimentalFeatures.e_dom_optimization
                        }
                    }, this.populateActiveBreakpointsConfig()
                }
                get Module() {
                    return this.isEditMode() && parent.designCommon.helpers.hardDeprecated("designFrontend.Module", "2.5.0", "designModules.frontend.handlers.Base"), designModules.frontend.handlers.Base
                }
                getDefaultSettings() {
                    return {
                        selectors: {
                ...
                getDefaultElements() {
                    const e = {
                        ...
                        $deviceMode: jQuery("<span>", {
                            id: "design-device-mode",
                            class: "design-screen-only"
                        })
                    };
                ...
                getPageSettings(e) {
                    const t = this.isEditMode() ? design.settings.page.model.attributes : this.config.settings.page;
                    return this.getItems(t, e)
                }
                getGeneralSettings(e) {
                    return this.isEditMode() && parent.designCommon.helpers.softDeprecated("getGeneralSettings", "3.0.0", "getKitSettings and remove the `design_` prefix"), this.getKitSettings(`design_${e}`)
                }
                getKitSettings(e) {
                ...
                getDeviceSetting(e, t, n) {
                    ...
                    const i = designFrontend.breakpoints.getActiveBreakpointsList({
                        largeToSmall: !0,
                        withDesktop: !0
                    });
                    let s = i.indexOf(e);
                ...
                getCurrentDeviceSetting(e, t) {
                    return this.getDeviceSetting(designFrontend.getCurrentDeviceMode(), e, t)
                }
                isEditMode() {
                ...
                initOnReadyComponents() {
                    this.utils = {
                        ...
                        StretchElement: designModules.frontend.tools.StretchElement,
                        Masonry: designModules.utils.Masonry
                    }, this.elementsHandler.init(), this.isEditMode() ? design.once("document:loaded", (() => this.onDocumentLoaded())) : this.onDocumentLoaded()
                }
                initOnReadyElements() {
                ...
                setDeviceModeData() {
                    this.elements.$body.attr("data-design-device-mode", this.getCurrentDeviceMode())
                }
                ...
                waypoint(e, t, n) {
                    ...
                    return e.designWaypoint((function() {
                ...
                initModules() {
                    ...
                    designFrontend.trigger("design/modules/init:before"), Object.entries(e).forEach((([e, t]) => {
                ...
                init() {
                    this.hooks = new v, this.breakpoints = new m.default(this.config.responsive), this.storage = new o.default, this.elementsHandler = new b(jQuery), this.modulesHandlers = {}, this.addUserAgentClasses(), this.setDeviceModeData(), this.initDialogsManager(), this.isEditMode() && this.muteMigrationTraces(), this.elements.$window.trigger("design/frontend/init"), this.initModules(), this.initOnReadyElements(), this.initOnReadyComponents()
                }
                onDocumentLoaded() {
                    this.documentsManager = new s.default, this.trigger("components:init"), new h.default
                }
            }
            window.designFrontend = new Frontend, designFrontend.isEditMode() || jQuery((() => designFrontend.init()))
        },
        4058: (e, t) => {
            "use strict";
            Object.defineProperty(t, "__esModule", {
            ...
            class BackgroundSlideshow extends designModules.frontend.handlers.SwiperBase {
                getDefaultSettings() {
                    return {
                        classes: {
                            swiperContainer: "design-background-slideshow swiper-container",
                            swiperWrapper: "swiper-wrapper",
                            swiperSlide: "design-background-slideshow__slide swiper-slide",
                            slideBackground: "design-background-slideshow__slide__image",
                            kenBurns: "design-ken-burns",
                            kenBurnsActive: "design-ken-burns--active",
                            kenBurnsIn: "design-ken-burns--in",
                            kenBurnsOut: "design-ken-burns--out"
                        }
                    }
                }
                getSwiperOptions() {
        ...
        6397: (e, t) => {
            ...
            class GlobalHandler extends designModules.frontend.handlers.Base {
                getWidgetType() {
                    return "global"
                }
                animate() {
                    const e = this.$element,
                        t = this.getAnimation();
                    if ("none" === t) return void e.removeClass("design-invisible");
                    ...
                    e.removeClass(t), this.currentAnimation && e.removeClass(this.currentAnimation), this.currentAnimation = t, setTimeout((() => {
                        e.removeClass("design-invisible").addClass("animated " + t)
                    }), i)
                }
                getAnimation() {
                ...
                onInit(...e) {
                    if (super.onInit(...e), this.getAnimation()) {
                        const e = designModules.utils.Scroll.scrollObserver({
                            callback: t => {
            ...
            t.default = e => {
                designFrontend.elementsHandler.addHandler(GlobalHandler, {
                    $element: e
                })
            }
        },
        2987: (e, t) => {
            ...
            class BackgroundVideo extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            backgroundVideoContainer: ".design-background-video-container",
                            backgroundVideoEmbed: ".design-background-video-embed",
                            backgroundVideoHosted: ".design-background-video-hosted"
                        }
                    }
                }
                getDefaultElements() {
                ...
                prepareVimeoVideo(e, t) {
                    ...
                    this.player = new e.Player(this.elements.$backgroundVideoContainer, i), this.handleVimeoStartEndTimes(n), this.player.ready().then((() => {
                        jQuery(this.player.element).addClass("design-background-video-embed"), this.changeVideoSize()
                    }))
                }
                ...
                prepareYTVideo(e, t) {
                    ...
                    const o = {
                        ...
                        events: {
                            ...
                            onStateChange: t => {
                                switch (t.data) {
                                    case s:
                                        n.removeClass("design-invisible design-loading");
                                        break;
                    ...
                    i.background_privacy_mode && (o.host = "https://www.youtube-nocookie.com", o.origin = window.location.hostname), n.addClass("design-loading design-invisible"), this.player = new e.Player(this.elements.$backgroundVideoEmbed[0], o)
                }
                activate() {
                    let e, t = this.getElementSettings("background_video_link");
                    const n = this.getElementSettings("background_play_once");
                    if (-1 !== t.indexOf("vimeo.com") ? (this.videoType = "vimeo", this.apiProvider = designFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (this.videoType = "youtube", this.apiProvider = designFrontend.utils.youtube), this.apiProvider) e = this.apiProvider.getVideoIDFromURL(t), this.apiProvider.onApiReady((t => {
                    ...
                    designFrontend.elements.$window.on("resize", this.changeVideoSize)
                }
                deactivate() {
                    "youtube" === this.videoType && this.player.getIframe() || "vimeo" === this.videoType ? this.player.destroy() : this.elements.$backgroundVideoHosted.removeAttr("src").off("ended"), designFrontend.elements.$window.off("resize", this.changeVideoSize)
                }
                run() {
                    const e = this.getElementSettings();
                    (e.background_play_on_mobile || "mobile" !== designFrontend.getCurrentDeviceMode()) && ("video" === e.background_background && e.background_video_link ? this.activate() : this.deactivate())
                }
                onInit(...e) {
        ...
        355: (e, t) => {
            ...
            class HandlesPosition extends designModules.frontend.handlers.Base {
                isActive() {
                    return designFrontend.isEditMode()
                }
                isFirstSection() {
                    return this.$element[0] === document.querySelector(".design-edit-mode .design-top-section")
                }
                isOverflowHidden() {
                    return "hidden" === this.$element.css("overflow")
                }
                getOffset() {
                    if ("body" === design.config.document.container) return this.$element.offset().top;
                    const e = jQuery(design.config.document.container);
                    return this.$element.offset().top - e.offset().top
                }
                setHandlesPosition() {
                    const e = design.documents.getCurrent();
                    if (!e || !e.container.isEditable()) return;
                    const t = "design-section--handles-inside",
                        n = this.$element.find("> .design-element-overlay > .design-editor-section-settings");
                    if (design.settings.page.model.attributes.scroll_snap) return void this.$element.addClass(t);
        ...
        3384: (e, t) => {
            ...
            class Shapes extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            container: "> .design-shape-%s"
                        },
                        svgURL: designFrontend.config.urls.assets + "shapes/"
                    }
                }
                getDefaultElements() {
                    const e = {},
                ...
                getSvgURL(e, t) {
                    ...
                    return design.config.additional_shapes && e in design.config.additional_shapes && (n = design.config.additional_shapes[e], -1 < t.indexOf("-negative") && (n = n.replace(".svg", "-negative.svg"))), n
                }
                buildSVG(e) {
        ...
        2804: (e, t) => {
            ...
            class StretchedSection extends designModules.frontend.handlers.Base {
                bindEvents() {
                    const e = this.getUniqueHandlerID();
                    designFrontend.addListenerOnce(e, "resize", this.stretch), designFrontend.addListenerOnce(e, "sticky:stick", this.stretch, this.$element), designFrontend.addListenerOnce(e, "sticky:unstick", this.stretch, this.$element), designFrontend.isEditMode() && (this.onKitChangeStretchContainerChange = this.onKitChangeStretchContainerChange.bind(this), design.channels.editor.on("kit:change:stretchContainer", this.onKitChangeStretchContainerChange))
                }
                unbindEvents() {
                    designFrontend.removeListeners(this.getUniqueHandlerID(), "resize", this.stretch), designFrontend.isEditMode() && design.channels.editor.off("kit:change:stretchContainer", this.onKitChangeStretchContainerChange)
                }
                isActive(e) {
                    return designFrontend.isEditMode() || e.$element.hasClass("design-section-stretched")
                }
                initStretch() {
                    this.stretch = this.stretch.bind(this), this.stretchElement = new designModules.frontend.tools.StretchElement({
                        element: this.$element,
                        selectors: {
                ...
                getStretchContainer() {
                    return designFrontend.getKitSettings("stretched_section_container") || window
                }
                stretch() {
            ...
            e.exports = designModules.ViewModule.extend({
                getDefaultSettings: function() {
                    return {
                        ...
                        selectors: {
                            links: 'a[href*="#"]',
                            targets: ".design-element, .design-menu-anchor",
                ...
                bindEvents: function() {
                    designFrontend.elements.$document.on("click", this.getSettings("selectors.links"), this.handleAnchorLinks)
                },
                handleAnchorLinks: function(e) {
                    ...
                    if (location.hostname === n.hostname && i && !(n.hash.length < 2)) {
                        ...
                        if (t.length) {
                            var s = t.offset().top,
                                o = designFrontend.elements.$wpAdminBar,
                                r = jQuery(".design-section.design-sticky--active:visible");
                            o.length > 0 && (s -= o.height()), r.length > 0 && (s -= Math.max.apply(null, r.map((function() {
                                return jQuery(this).outerHeight()
                            })).get())), e.preventDefault(), s = designFrontend.hooks.applyFilters("frontend/handlers/menu_anchor/scroll_top_distance", s), this.elements.$scrollable.animate({
                                scrollTop: s
                ...
                onInit: function() {
                    designModules.ViewModule.prototype.onInit.apply(this, arguments), this.bindEvents()
                }
            })
        },
        6866: (e, t) => {
            ...
            const n = designFrontendConfig.environmentMode.isScriptDebug ? "" : ".min";
            AssetsLoader.assets = {
                script: {
                    dialog: {
                        src: `${designFrontendConfig.urls.assets}lib/dialog/dialog${n}.js?ver=4.8.1`
                    },
                    "share-link": {
                        src: `${designFrontendConfig.urls.assets}lib/share-link/share-link${n}.js?ver=${designFrontendConfig.version}`
                    },
                    swiper: {
                        src: `${designFrontendConfig.urls.assets}lib/swiper/swiper${n}.js?ver=5.3.6`
                    }
                },
                style: {}
            }
        ...
        8646: (e, t, n) => {
            ...
            class LightboxManager extends designModules.ViewModule {
                static getLightbox() {
                    const e = new Promise((e => {
                        ...
                        t = designFrontend.utils.assetsLoader.load("script", "dialog"),
                        i = designFrontend.utils.assetsLoader.load("script", "share-link");
                    return Promise.all([e, t, i]).then((() => e))
                }
                getDefaultSettings() {
                    return {
                        selectors: {
                            links: "a, [data-design-lightbox]"
                        }
                    }
                }
                getDefaultElements() {
                ...
                isLightboxLink(e) {
                    if ("a" === e.tagName.toLowerCase() && (e.hasAttribute("download") || !/^[^?]+\.(png|jpe?g|gif|svg|webp)(\?.*)?$/i.test(e.href)) && !e.dataset.designLightboxVideo) return !1;
                    const t = designFrontend.getKitSettings("global_image_lightbox"),
                        n = e.dataset.designOpenLightbox;
                    return "yes" === n || t && "no" !== n
                }
                async onLinkClick(e) {
                    const t = e.currentTarget,
                        n = jQuery(e.target),
                        i = designFrontend.isEditMode(),
                        s = i && design.$previewContents.find("body").hasClass("design-editor__ui-state__color-picker"),
                        o = !!n.closest(".design-edit-area").length;
                    if (!this.isLightboxLink(t)) return void(i && o && e.preventDefault());
                    if (e.preventDefault(), i && !design.getPreferences("lightbox_in_editor")) return;
                    if (s) return;
                    (this.isOptimizedAssetsLoading() ? await LightboxManager.getLightbox() : designFrontend.utils.lightbox).createLightbox(t)
                }
                isOptimizedAssetsLoading() {
                    return designFrontend.config.experimentalFeatures.e_optimized_assets_loading
                }
                bindEvents() {
                    designFrontend.elements.$document.on("click", this.getSettings("selectors.links"), (e => this.onLinkClick(e)))
                }
                onInit(...e) {
                    super.onInit(...e), this.isOptimizedAssetsLoading() && !designFrontend.isEditMode() && this.elements.$links.each(((e, t) => {
            ...
            class SwiperBC {
                constructor(e, t) {
                    return this.config = t, this.config.breakpoints && (this.config = this.adjustConfig(t)), t.legacy ? this.createSwiperInstance(e, this.config) : new Promise((t => {
                        if (!designFrontend.config.experimentalFeatures.e_optimized_assets_loading) return t(this.createSwiperInstance(e, this.config));
                        designFrontend.utils.assetsLoader.load("script", "swiper").then((() => t(this.createSwiperInstance(e, this.config))))
                    }))
                }
                createSwiperInstance(e, t) {
                    return !SwiperBC.isSwiperLoaded && designFrontend.config.experimentalFeatures.e_optimized_assets_loading && (n = window.Swiper, SwiperBC.isSwiperLoaded = !0, legacySwiper()), n.prototype.adjustConfig = this.adjustConfig, new n(e, t)
                }
                adjustConfig(e) {
                    if (!e.handledesignBreakpoints) return e;
                    const t = designFrontend.config.responsive.activeBreakpoints,
                        n = designFrontend.breakpoints.getBreakpointValues();
        ...
        2064: (e, t) => {
            ...
            class _default extends designModules.ViewModule {
                getDefaultSettings() {
                    return {
                        selectors: {
                            links: 'a[href^="%23design-action"], a[href^="#design-action"]'
                        }
                    }
                }
                bindEvents() {
                    designFrontend.elements.$document.on("click", this.getSettings("selectors.links"), this.runLinkAction.bind(this))
                }
                initActions() {
                    this.actions = {
                        lightbox: async e => {
                            const t = await designFrontend.utils.lightbox;
                ...
                createActionHash(e, t) {
                    return encodeURIComponent(`#design-action:action=${e}&settings=${btoa(JSON.stringify(t))}`)
                }
                onInit() {
                    super.onInit(), this.initActions(), designFrontend.on("components:init", this.runHashAction.bind(this))
                }
            }
            t.default = _default
        },
        ...
        4773: (e, t) => {
            ...
            class BaseLoader extends designModules.ViewModule {
                getDefaultSettings() {
                    return {
                        isInserted: !1,
                        selectors: {
        ...
        4375: (e, t) => {
            ...
            class Breakpoints extends designModules.Module {
                constructor(e) {
        ...
        5107: (e, t) => {
            ...
            class _default extends designModules.Module {
                get(e, t) {
                    let n;
                    t = t || {};
                    try {
                ...
                save(e, t) {
                    ...
                    n.setItem("design", JSON.stringify(e))
                }
            }
            t.default = _default
        },
        6046: (e, t, n) => {
            ...
            class _default extends designModules.Module {
                constructor() {
                    super(), designFrontend.elementsHandler.attachHandler("text-path", (() => n.e(48).then(n.bind(n, 6468))))
                }
            }
            t.default = _default
        }
...
(self.webpackChunkdesign = self.webpackChunkdesign || []).push([
    [882, 723, 209, 745, 120, 192, 520, 181, 791, 268, 357], {
        ...
        9269: (e, t) => {
            ...
            class Alert extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            dismissButton: ".design-alert-dismiss"
                        }
                    }
                }
                getDefaultElements() {
        ...
        9728: (e, t) => {
            ...
            class baseTabs extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            tablist: '[role="tablist"]',
                            tabTitle: ".design-tab-title",
                            tabContent: ".design-tab-content"
                        },
                        classes: {
                        ...
                        autoExpand: !0,
                        keyDirection: {
                            ArrowLeft: designFrontendConfig.is_rtl ? 1 : -1,
                            ArrowUp: -1,
                            ArrowRight: designFrontendConfig.is_rtl ? -1 : 1,
                            ArrowDown: 1
                        }
                    }
                }
                ...
                activateTab(e) {
                    ...
                    i.add(n).addClass(s), i.attr({
                        ...
                        "aria-selected": "true",
                        "aria-expanded": "true"
                    }), n[t.showTabFn](o, (() => designFrontend.elements.$window.trigger("resize"))), n.removeAttr("hidden")
                }
                isActiveTab(e) {
        ...
        7884: (e, t) => {
            ...
            class Counter extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            counterNumber: ".design-counter-number"
                        }
                    }
                }
                getDefaultElements() {
                ...
                onInit() {
                    super.onInit(), this.intersectionObserver = designModules.utils.Scroll.scrollObserver({
                        callback: e => {
                            if (e.isInViewport) {
        ...
        5914: (e, t) => {
            ...
            class ImageCarousel extends designModules.frontend.handlers.SwiperBase {
                getDefaultSettings() {
                    return {
                        selectors: {
                            carousel: ".design-image-carousel-wrapper",
                ...
                getSwiperSettings() {
                    const e = this.getElementSettings(),
                        ...
                        s = 1 === t,
                        i = designFrontend.config.responsive.activeBreakpoints,
                        n = {
                            mobile: 1,
                            tablet: s ? 1 : 2
                        },
                ...
                async onInit(...e) {
                    ...
                    const s = designFrontend.utils.swiper;
        ...
        1351: (e, t) => {
            ...
            class Progress extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            progressNumber: ".design-progress-bar"
                        }
                    }
                }
                getDefaultElements() {
                ...
                onInit() {
                    super.onInit(), designFrontend.waypoint(this.elements.$progressNumber, (() => {
        ...
        1327: (e, t) => {
            ...
            class TextEditor extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            paragraph: "p:first"
                        ...
                        classes: {
                            dropCap: "design-drop-cap",
                            dropCapLetter: "design-drop-cap-letter"
                        }
                    }
                }
                getDefaultElements() {
        ...
        5363: (e, t) => {
            ...
            class Video extends designModules.frontend.handlers.Base {
                getDefaultSettings() {
                    return {
                        selectors: {
                            imageOverlay: ".design-custom-embed-image-overlay",
                            video: ".design-video",
                            videoIframe: ".design-video-iframe"
                        }
                    }
                }
                getDefaultElements() {
                ...
                async animateVideo() {
                    (await designFrontend.utils.lightbox).setEntranceAnimation(this.getCurrentDeviceSetting("lightbox_content_animation"))
                }
                async handleAspectRatio() {
                    (await designFrontend.utils.lightbox).setVideoAspectRatio(this.getElementSettings("aspect_ratio"))
                }
                async hideLightbox() {
                    (await designFrontend.utils.lightbox).getModal().hide()
                }
                prepareYTVideo(e, t) {
                ...
                onInit() {
                    super.onInit();
                    const e = this.getElementSettings();
                    if (designFrontend.utils[e.video_type] ? this.apiProvider = designFrontend.utils[e.video_type] : this.apiProvider = designFrontend.utils.baseVideoLoader, "youtube" === e.video_type && (this.videoID = this.apiProvider.getVideoIDFromURL(e.youtube_url), this.videoID && (!e.show_image_overlay || !e.image_overlay.url))) return e.lazy_load ? (this.intersectionObserver = designModules.utils.Scroll.scrollObserver({
                        callback: e => {
                    ...
                    }), void this.intersectionObserver.observe(this.elements.$video.parent()[0])) : void(designFrontend.config.experimentalFeatures.e_optimized_assets_loading ? this.apiProvider.onApiReady((e => this.prepareYTVideo(e))) : setTimeout((() => {
        ...
        1210: (e, t, s) => {
            ...
            var i = s(7914),
                ...
                u = i(s(1327)),
                p = i(s(3896));
            designFrontend.elements.$window.on("design/frontend/init", (() => {
                designFrontend.elementsHandler.elementsHandlers = {
                ...
                }, designFrontend.on("components:init", (() => {
                    delete designFrontend.utils.lightbox, designFrontend.utils.lightbox = new p.default
                }))
            }))
        },
        3896: (e, t, s) => {
            ...
            e.exports = designModules.ViewModule.extend({
                ...
                getDefaultSettings: function() {
                    return {
                        classes: {
                            aspectRatio: "design-aspect-ratio-%s",
                            item: "design-lightbox-item",
                            image: "design-lightbox-image",
                            videoContainer: "design-video-container",
                            videoWrapper: "design-fit-aspect-ratio",
                            playButton: "design-custom-embed-play",
                            playButtonIcon: "fa",
                            playing: "design-playing",
                            hidden: "design-hidden",
                            invisible: "design-invisible",
                            preventClose: "design-lightbox-prevent-close",
                            slideshow: {
                                container: "swiper-container",
                                slidesWrapper: "swiper-wrapper",
                                prevButton: "design-swiper-button design-swiper-button-prev",
                                nextButton: "design-swiper-button design-swiper-button-next",
                                prevButtonIcon: "eicon-chevron-left",
                                nextButtonIcon: "eicon-chevron-right",
                                slide: "swiper-slide",
                                header: "design-slideshow__header",
                                footer: "design-slideshow__footer",
                                title: "design-slideshow__title",
                                description: "design-slideshow__description",
                                counter: "design-slideshow__counter",
                                iconExpand: "eicon-frame-expand",
                                iconShrink: "eicon-frame-minimize",
                                iconZoomIn: "eicon-zoom-in-bold",
                                iconZoomOut: "eicon-zoom-out-bold",
                                iconShare: "eicon-share-arrow",
                                shareMenu: "design-slideshow__share-menu",
                                shareLinks: "design-slideshow__share-links",
                                hideUiVisibility: "design-slideshow--ui-hidden",
                                shareMode: "design-slideshow--share-mode",
                                fullscreenMode: "design-slideshow--fullscreen-mode",
                                zoomMode: "design-slideshow--zoom-mode"
                            }
                        },
                        selectors: {
                            image: ".design-lightbox-image",
                ...
                initModal: function() {
                    const t = e.exports.modal = designFrontend.getDialogsManager().createWidget("lightbox", {
                        ...
                        closeButtonOptions: {
                            ...
                            attributes: {
                                tabindex: 0,
                                role: "button",
                                "aria-label": designFrontend.config.i18n.close + " (Esc)"
                            }
                        },
                        selectors: {
                ...
                createLightbox: function(e) {
                    let t = {};
                    if (e.dataset.designLightbox && (t = JSON.parse(e.dataset.designLightbox)), t.type && "slideshow" !== t.type) return void this.showModal(t);
                    if (!e.dataset.designLightboxSlideshow) {
                        const t = "single-img";
                        return void this.showModal({
                            type: "image",
                            id: t,
                            url: e.href,
                            title: e.dataset.designLightboxTitle,
                            description: e.dataset.designLightboxDescription,
                            modalOptions: {
                                id: "design-lightbox-slideshow-" + t
                            }
                        })
                    }
                    const s = e.dataset.designLightboxVideo || e.href;
                    this.openSlideshow(e.dataset.designLightboxSlideshow, s)
                },
                setHTMLContent: function(e) {
                    window.designCommon && designCommon.helpers.hardDeprecated("designFrontend.utils.lightbox.setHTMLContent", "3.1.4"), this.getModal().setMessage(e)
                },
                setVideoContent: function(e) {
                    ...
                    if ("hosted" === e.videoType) {
                        ...
                        let s = designFrontend.utils.baseVideoLoader; - 1 !== e.url.indexOf("vimeo.com") ? s = designFrontend.utils.vimeo : e.url.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (s = designFrontend.utils.youtube), a = t("<iframe>", {
                    ...
                    const r = o.onHide;
                    o.onHide = function() {
                        r(), this.$buttons = jQuery(), this.focusedButton = null, o.getElements("message").removeClass("design-fit-aspect-ratio")
                    }
                },
                getShareLinks: function() {
                    const {
                        i18n: e
                    } = designFrontend.config, t = {
                    ...
                    }), a = this.getSlide("active"), r = a.find(n.image), l = a.data("design-slideshow-video");
                    let d;
                ...
                createShareLink: function(e, t) {
                    ...
                    if ("pinterest" === e) s.image = encodeURIComponent(t);
                        ...
                        const e = designFrontend.utils.urlActions.createActionHash("lightbox", {
                            id: this.id,
                            url: t
                        });
                ...
                getSlideshowHeader: function() {
                    const {
                        i18n: e
                    } = designFrontend.config, t = jQuery, s = "yes" === designFrontend.getKitSettings("lightbox_enable_counter"), i = "yes" === designFrontend.getKitSettings("lightbox_enable_fullscreen"), n = "yes" === designFrontend.getKitSettings("lightbox_enable_zoom"), o = "yes" === designFrontend.getKitSettings("lightbox_enable_share"), a = this.getSettings("classes"), r = a.slideshow, l = this.elements;
                    if (s || i || n || o) {
                ...
                setSlideshowContent: function(e) {
                    const {
                        i18n: t
                    } = designFrontend.config, s = jQuery, i = 1 === e.slides.length, n = "" !== designFrontend.getKitSettings("lightbox_title_src"), o = "" !== designFrontend.getKitSettings("lightbox_description_src"), a = n || o, r = this.getSettings("classes"), l = r.slideshow, d = s("<div>", {
                        class: l.container
                    }), c = s("<div>", {
                    ...
                    e.slides.forEach((e => {
                        ...
                        if (e.video) {
                            n.attr("data-design-slideshow-video", e.video);
                            const i = s("<div>", {
                                class: r.playButton
                            }).html(s("<i>", {
                    ...
                    p.onShow = async () => {
                        ...
                        const n = designFrontend.utils.swiper;
                ...
                updateFooterText: function() {
                    ...
                    const e = this.getSettings("classes"),
                        t = this.getSlide("active").find(".design-lightbox-image"),
                        s = t.data("title"),
                ...
                playSlideVideo: function() {
                    const e = this.getSlide("active"),
                        t = e.data("design-slideshow-video");
                    if (!t) return;
                    ...
                    let a, r;
                    i.append(n), e.append(i), -1 !== t.indexOf("vimeo.com") ? (a = "vimeo", r = designFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (a = "youtube", r = designFrontend.utils.youtube);
                ...
                prepareYTVideo: function(e, t, s, i, n) {
                    ...
                    i.append(a), window.chrome && (r = e.PlayerState.UNSTARTED), s.addClass("design-loading " + o.invisible), this.player = new e.Player(a[0], {
                        videoId: t,
                        events: {
                            onReady: () => {
                            ...
                            onStateChange: e => {
                                e.data === r && s.removeClass("design-loading " + o.invisible)
                            }
                        },
                        playerVars: {
                            controls: 0,
                ...
                setEntranceAnimation: function(e) {
                    e = e || designFrontend.getCurrentDeviceSetting(this.getSettings("modalOptions"), "entranceAnimation");
                ...
                openSlideshow: function(e, t) {
                    const s = jQuery(this.getSettings("selectors.links")).filter(((t, s) => {
                            const i = jQuery(s);
                            return e === s.dataset.designLightboxSlideshow && !i.parent(".swiper-slide-duplicate").length && !i.parents(".slick-cloned").length
                        })),
                        i = [];
                    let n = 0;
                    s.each((function() {
                        const e = this.dataset.designLightboxVideo;
                        let o = this.dataset.designLightboxIndex;
                        void 0 === o && (o = s.index(this)), (t === this.href || e && t === e) && (n = o);
                        const a = {
                            image: this.href,
                            index: o,
                            title: this.dataset.designLightboxTitle,
                            description: this.dataset.designLightboxDescription
                        };
                        ...
                        id: e,
                        modalOptions: {
                            id: "design-lightbox-slideshow-" + e
                        },
                        slideshow: {
                            slides: i,
                            swiper: {
